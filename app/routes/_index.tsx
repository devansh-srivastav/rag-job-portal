...
export async function action({ request }: ActionFunctionArgs) {
  ...
  const slug = `${author_name.toLowerCase().replace(/\s/g, '')}-${randomSequence}`;
  await xata.db.content.create({ slug, title, content, location, apply_url, experience_level, job_type, author_name, author_image_url, author_image_w, author_image_h, og_image_url, og_image_w, og_image_h })
